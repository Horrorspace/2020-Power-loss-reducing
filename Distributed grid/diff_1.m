...
Unom = 10; % номинальное напряжение сети [кВ]
  ...
  v(15) = 0.06; v(16) = 0.06; v(17) = 0.06; v(18) = 0.09; v(32) = 0.21; v(33) = 0.06; 
 ...
 for (k = 1:32) % вычисление активных, реактивных и полных сопротивлений линий
  ...
  while (Perc > e) % итерационный расчёт потоков, напряжений в узлах, а также потерь мощности и напряжения
