...
Unom = 10; % номинальное напряжение сети [кВ]
  ...
  %v = [0.06; 0.045; 0.06; 0.06; 0.12; 0.06; 0.06; 0.06; 0.09; 0.15; 0.21; 0.06];
  %v = zeros(1, 33);
 ...
 %abs(U)
 %xlswrite('E:\Edu\Диплом (м)\Программа в Matlab\Distributed grid\deltaU.xls',abs(U));
  f = dP_sum;
